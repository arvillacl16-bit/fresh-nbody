...
#pragma omp parallel for
    ...
    switch (gravity) {
    case GravityMethod::BASIC: accel::basic(particles, epsilon * epsilon); break;
    case GravityMethod::COMPENSATED: accel::compensated(particles, epsilon * epsilon); break;
    case GravityMethod::JACOBI: accel::jacobi(particles, epsilon * epsilon); break;
    default: break;
    }
